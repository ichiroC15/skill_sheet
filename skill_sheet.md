...
## 自己PR
### 【職務概要】
前職では求人アグリゲーションサイト(会員数100万人以上、総求人数40万以上)の開発・運用を行った。組織のメンバー4人は皆エンジニアで、開発・運用はもちろん、企画からコードレビュー、CSまで全員で対応していた。その中でも主に求人提供元サイトとの連携、他アグリゲーションサイトへの求人情報送信を担当した(詳細は別欄に記載)。

### 【自己研鑽】
事業目標の策定にも積極的に関わり、サービスの改善のために新しいアイデアを自ら提案して開発を行ってきた。
技術に関しては好き嫌いよりも業務で役に立つかどうかで判断することが多く、研修がない中で隙間時間を使い独力で学習してきた。
技術的なもの以外でもGoogleAnalyticsやデータ分析の手法、業界の動向についての情報を絶えず仕入れ、自分にできることを増やそうと努力している。
### 【キャリアプラン】
サービス志向のエンジニアを目指しており、そのために技術的引き出しを多くもつこと、適切な技術を選択できる深い理解が必要と考えている。
将来的には社会課題を技術で解決できるサービスの開発の立ち上げから関わりたい。同時に課題を正確に分析し把握できる能力も身に付け、俯瞰的にサービスを見ることができるエンジニアでありたいと思っている。

### 【技術的志向】
常に技術やニーズの変化に対応できることが理想だと思っており、究極的にはコアの部分を常にシンプルに保つ構成が理想である。
Ruby, PHPといった柔軟性の高い言語を現職で使用する一方で、処理速度と堅牢さに優れたGo, Rustにも魅力を感じており、自主的な学習と勉強会への参加を行っている。
